export default function AcademicsHover() {
  return (
    <div id="adademicshover" className="justify-center items-center hidden">
      {" "}
      <div className="mt-6 gap-6 space-y-4 md:grid md:grid-cols-2 md:space-y-0 w-[50%]">
